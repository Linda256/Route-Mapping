...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List <Integer> distance1List = getNeighbors(v);
		 for (int i=0;i<distance1List.size();i++){
			 int n=distance1List.get(i);
			 distance2List.addAll(getNeighbors(n));
//			 List<Integer> nNeighbors = getNeighbors(n);
//			 for (int j=0;j<nNeighbors.size();j++){
//				 distance2List.add(nNeighbors.get(j));
//			 }
		 }
